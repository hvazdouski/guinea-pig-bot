...
# --- ПОЛНАЯ БАЗА ДАННЫХ (Исправлены пробелы!) ---
PLANTS_DB = {
    # --- ОВОЩИ ---
    "морковь": {
        "cat": "🥬 Овощи",
    ...
    "одуванчик": {
        ...
        "parts": {
            ...
            "стебли": {"status": "✅ Можно всё", "info": "Содержит молочко.", "norm": "Ежедневно."}
        },
...
def start(message):
    # Используем ссылку, чтобы не зависеть от наличия файла на сервере
    ...
    text = (
        ...
        "Я помогу тебе понять, можно ли твоему питомцу то или иное растение. "
        "Просто выбери категорию ниже или напиши название продукта текстом!"
    )
