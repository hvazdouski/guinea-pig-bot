...
Я помогу тебе понять, можно ли твоему питомцу то или иное растение, овощ, фрукт или траву, и в каком количестве.
...
def start(message):
    ...
    bot.send_message(message.chat.id, "🐹 Привет! Я бот-помощник по питанию морских свинок.
    Я помогу тебе понять, можно ли твоему питомцу то или иное растение, овощ, фрукт или ягоду, и в каком количестве.
    🔍 Как пользоваться:
    Просто напиши мне название продукта (например: огурец, петрушка, перец), и я выдам подробную информацию о пользе, вреде и норме потребления! Или ты можешь выбрать интересующую тебя категорию:", reply_markup=markup)
